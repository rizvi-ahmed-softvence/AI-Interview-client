    ...
    <div className="grid grid-cols-1 gap-4">
      <Link to="/userDashboard/settings-manage/general-settings" className="block">
        <div className="flex justify-between items-center bg-white p-5 rounded-lg hover:shadow-md transition">
          ...
          <FaArrowRightLong className="text-white bg-[#6a329f] rounded-full w-8 h-8 p-2" />
        </div>
      </Link>
      ...
      <Link to="/userDashboard/settings-manage/landing-page-manage" className="block">
        <div className="flex justify-between items-center bg-white p-5 rounded-lg hover:shadow-md transition">
          <h2 className="text-[#212121] text-[16px] md:text-[20px] lg:text-[20px] font-medium">Manage Your Landing Page</h2>
          <FaArrowRightLong className="text-white bg-[#6a329f] rounded-full w-8 h-8 p-2" />
        </div>
      </Link>
